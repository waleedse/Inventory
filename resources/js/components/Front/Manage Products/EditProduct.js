...
class EditProduct extends Component {
    ...
    componentDidMount(){
        ...
        Axios.post('/api/get_product_by_id',data).then(res=>{
            let dat = res.data;
            this.setState({
                p_code:dat.code,
                p_name:dat.name,
                ...
                stock:dat.stock,
                purchase_price:dat.purchase_price,
                retail_price:dat.retail_price,
                cat_id:dat.category_id
            })
        })
    }
    ...
    handleSubmit(e) {
        ...
        Axios.post('/api/update_product', senderdata)
            .then(res => {
                this.setState({
                    loading:false
                })
            if(res.data.status == 200){
                ...
                this.props.history.push('/pos/products-list');
                    ...
                    <div className="card p-3 content_card_div mt-4 mb-5">
                        <div className="row col-md-12">
                            <div class="form-group input_div col-md-6">
                                ...
                                <input value={this.state.p_code || ""} onChange={this.p_code.bind(this)} type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  />
                            </div>
                            <div class="form-group input_div col-md-6">
                                <label className="input_label" for="exampleInputEmail1">Product Name</label>
                                <input value={this.state.p_name || ""}  onChange={this.p_name.bind(this)}  type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  />
                            </div>


                           <div class="form-group input_div col-md-6">
                               <label className="input_label" for="exampleInputEmail1">Category</label>
                               <select value={this.state.cat_id || ""}  onChange={this.cat_id.bind(this)} type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  >
                            ...
                            <div class="form-group input_div col-md-6">
                                ...
                                <input value={this.state.purchase_price || ""}  onChange={this.purchase_price.bind(this)}  type="number" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  />
                            </div>
                            <div class="form-group input_div col-md-6">
                                <label className="input_label" for="exampleInputEmail1">Retail Price</label>
                                <input value={this.state.retail_price || ""}  onChange={this.retail_price.bind(this)}  type="number" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  />
                            </div>
                            <div class="form-group input_div col-md-6">
                                <label className="input_label" for="exampleInputEmail1">Available Stock</label>
                                <input value={this.state.stock || ""}  onChange={this.stock.bind(this)}  type="number" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  />
                            </div>
                        </div>
                        ...
                        <div className="row col-md-12">
                            ...
                            <div class="form-group input_div   col-md-6">
                                ...
                                <select value={this.state.p_quantity_type || ""}  onChange={this.p_quantity_type.bind(this)}  type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  >
                                    <option value="">Choose..</option>
